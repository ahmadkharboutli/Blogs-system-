...
<head>
    ...
    <title>Hyber blog . all post</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid d-flex justify-content-between">
            <a href="{{ route('PublicPosts.allPosts') }}" class="navbar-brand d-flex align-items-center">
    ...
    @yield('content')
    <footer class="p-3 mb-2 bg-light text-dark py-5">
